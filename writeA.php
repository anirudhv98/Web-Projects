...
<body>
	...
	<div class="main1">
		...
		<textarea id="heading" placeholder="Heading"></textarea>
		<textarea id="caption" placeholder="A small Caption..."></textarea>
		<textarea id="text" placeholder="Main Text: Enter HTML tags to style your text\n IMPORTANT: SUBMIT IMAGES FIRST"></textarea><br>
		<textarea id="img0" placeholder="Enter title Image URL "></textarea>
		<textarea id="img1" placeholder="Enter smaller Image URL"></textarea>
		<button id="sub1">Submit Article</button>
	</div>
